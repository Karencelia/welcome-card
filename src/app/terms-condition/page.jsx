...
export default function Home() {
    return (
        <div className="h-auto py-8">
            ...
            <div className="w-full max-w-[90%] md:max-w-[75%] mx-auto mt-10 md:mt-50 px-4">
                <h1 className="text-3xl md:text-[70px] font-bold text-[#0c005b] mb-4 md:mb-6">Terms & Conditions</h1>

                <p className="text-sm md:text-[16px] text-gray-700 mb-6 md:mb-10">
                ...
                <p className="text-[#5a00a1] font-light mb-6 md:mb-8">Last updated: 2nd December 2022</p>
                ...
                <div className="mb-6 md:mb-8">
                    ...
                    <p className="text-sm md:text-[16px] text-gray-700 mb-3 md:mb-4">Welcome finance group/Welcome Card is not liable for any damages that may occur to youas a result of your misuse of our service.                        
                    </p>
                    <p className="text-sm md:text-[16px] text-gray-700 mb-3 md:mb-4">
